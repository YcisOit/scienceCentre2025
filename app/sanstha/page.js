    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative w-full h-40 md:h-52">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center">
          ...
          <div className="flex items-center space-x-2 bg-white/10 px-4 py-2 mt-4 rounded-full shadow text-sm">
            <HomeIcon size={18} />
      ...
      <div className="max-w-5xl mx-auto px-4 md:px-8 py-10 space-y-12">
        ...
        <section>
          ...
          <p className="text-gray-700 leading-relaxed mb-3">
            ...
            creed, or background. With 4.5 lakh students in 739 branches and
            supported by 16,000 staff, the Sanstha continues to transform lives
            through quality education.
          </p>

          <p className="text-gray-700 leading-relaxed">
            Rayat Shikshan Sanstha is a premier educational institution, renowned
            nationally and globally. Founded by Karmaveer Bhaurao Patil and
            supported by his wife, Sou. Laxmibai Patil, the institution has been
            dedicated to the noble mission of education and social upliftment.
            Over the years, Rayat Shikshan Sanstha has expanded its reach,
            providing quality education to students from diverse backgrounds. With
            numerous schools, colleges, and professional institutes under its
            umbrella, it continues to empower the youth through knowledge and
            skill development.
          </p>
        </section>
      </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-wrap justify-center gap-15">
            {committeeMembers.map((member, index) => (
              <div
                key={index}
                className="w-72 bg-white rounded-2xl shadow-lg p-6 text-center hover:shadow-xl transition-all duration-300"
              >
