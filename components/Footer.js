...
export default function Footer() {
  return (
    <footer className="bg-[#073B3A] text-white pt-10 pb-4 px-4 md:px-20 bg-[url('/images/footerbackground.jpeg')] bg-cover bg-center bg-no-repeat">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mt-8 text-sm">
        ...
        <div>
          ...
          <p className="text-gray-300">
            Rayat
            Science and Innovation Activity Centre is one of the major tourist attractions and activity-based Science Centre of Satara region...
          </p>
        ...
        <div>
          ...
          <p className="mt-2 font-semibold text-white text-lg">+91 8605145013</p>
          <p className="text-gray-300">rayatsciencecenter@gmail.com</p>
        </div>
      </div>

{/* Bottom Section */}
<div className="flex flex-col items-center justify-center mt-10 border-t border-white pt-4 text-white">
